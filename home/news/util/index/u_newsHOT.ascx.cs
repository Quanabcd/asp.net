...
public partial class home_news_util_index_u_newsHOT : System.Web.UI.UserControl
{
    ...
    protected void LoadItemsList1()
    {
        ...
        dt = WEB.Items.getlistitembypage(fieldsearch, "2", condition, 0, 5, "iparam1 asc , dupdate asc");
