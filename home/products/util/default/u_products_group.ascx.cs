...
{
    public string catename = TN.Common.GetLabel("lbnhomsanpham", "Nhóm sản phẩm", TN.Common.Lang);
    public int p = 0;
    ...
    protected void LoadItemsList()
    {
        ...
        string orderby = "ithutu asc, dcreatedate DESC ";
        if (sort == 0)
        ...
        numitems = WEB.Group.getnumitems("", new string[0], WEB.Common.mod_product_group, icid, condition, "1");
        string[] getfield = { "ino", "tb1.iid", "tb1.ithutu", "tb1.istatus", "tb1.dcreatedate", "vtitle", "valias", "vimg", "vkey", "vdesc", "foldprice", "fnewprice" };
        dt= WEB.Group.getlistitemfullbypage(icid, new string[0], "", getfield, WEB.Common.mod_product_group, "", "1", p - 1, itemperpage, "ithutu asc");
