...
public partial class home_services_util_menu_u_vertical_bycate : System.Web.UI.UserControl
{
    ...
    void LoadMenu()
    {
        ...
        ltmenu.Text += Menu("-1", WEB.Common.mod_service);
    }
    ...
    {
        DataTable dt = new DataTable();
        WEB.Category.getcategorylevel1(ref dt, icid, WEB.Common.mod_service, lang, "1");
        string str = "";
        if (dt.Rows.Count > 0)
        {
