...
public partial class home_products_default_u_products_cate : System.Web.UI.UserControl
{
    ...
    protected void LoadItemsList()
    {
        ...
        numitems = WEB.Group.getnumitems("", new string[0],"HGR", icid, condition, "1");
        string[] getfield = { "ino", "tb1.iid", "tb1.ithutu", "tb1.istatus", "tb1.dcreatedate", "vtitle", "valias", "vimg", "vkey", "vdesc", "foldprice", "fnewprice" };
        dt= WEB.Group.getlistitemfullbypage(icid, new string[0], "", getfield,"HGR", "", "1", p - 1, itemperpage, "ithutu asc");
