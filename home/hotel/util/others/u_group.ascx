<%@ Control Language="C#" AutoEventWireup="true" CodeFile="u_group.ascx.cs" Inherits="home_products_util_others_u_venders" %>

<aside class="aside-filter aside-filter-css">
    <div class="aside-title">
        <h2 class="title-head margin-top-0"><span>Nhóm Hotel</span></h2>
    </div>
