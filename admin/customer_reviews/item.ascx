                            ...
                            <p>
                                <table cellspacing="1" class="admintable">
                                    <tbody>
                                        <tr>
                                            <td class="key">
                                                <label for="txtuser">Tên khách hàng(<span class="requirecss">*</span>)</label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="key" valign="top">
                                                <label for="txtphone">Công ty</label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="key" valign="top">
                                                <label for="txtphone">Ý kiến</label>
                                            </td>
                                            <td>
