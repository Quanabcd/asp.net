<%@ control language="C#" autoeventwireup="true" inherits="admin_integrated_analytics, App_Web_amcji1rc" %>
<div class="widget">
                                         ...
                                         <table cellspacing="1" class="admintable">
                                                <tbody>
                                                   <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtcoderemarketing" TextMode="MultiLine" CssClass="inputbox" runat="server" Width="500" Height="100"></asp:TextBox>
                                                            <a href="#" class="tooltip">
                                                                <img src="../templates/admin/images/help-icon.png" />
