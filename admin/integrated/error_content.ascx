<%@ control language="C#" autoeventwireup="true" inherits="admin_integrated_error_content, App_Web_amcji1rc" %>
                        ...
                        <p>
                            <table width="100%" cellspacing="1" class="admintable">
                                <tbody>
                                   ...
                                   <tr>
                                            <td class="key" style="width:160px" valign="top">
                                                <label for="txtphone">Nội dung trang lỗi 404</label>
                                                  <a href="#" class="tooltip">
                                                <img src="../templates/admin/images/help-icon.png" />
                                                <span><b>Nội dung trang lỗi 404</b><br />
                                                    Nội dung hiển thị trên website khi link không đúng
                                                </span>
                                            </a>
                                            </td>
                                            <td>
