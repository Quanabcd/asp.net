...
public partial class admin_menus_u_menucontent : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ddlcate.Items.Clear();
        ddlcate.Items.Add(new ListItem("Nội dung", "-1"));
    ...
    protected void lnkupdate_Click(object sender, EventArgs e)
    {
        ...
        if (hd_insertupdate.Value.Equals("insert"))
        {
            ...
            try
            {
                ...
                WEB.Category.db_categories_insert(WEB.Common.mod_menucont, vlan, ddlcate.SelectedValue, "", txtname.Text.Trim(), txtlink.Text.Trim(), type, image, Convert.ToInt32(Session["userid"]), Session["admin"].ToString(), DateTime.Now.ToString("MM/dd/yyyy hh:mm:ss tt"), DateTime.Now.ToString("MM/dd/yyyy hh:mm:ss tt"), ilevel, txtorder.Text, istatus, txtdesc.Text, hdicate.Value, "", "", "", "0", "0", "0", "0", "0");
                lttitle.Text = "Quản lý menu - Thêm menu thành công";
                //ghi log
                string id = WEB.Dataprovider.getmax("db_categories", "icid", "").ToString();
                WEB.Logs.writelog("Thêm Nội dung: " + txtname.Text);
                UpdateList();
            }
            catch
            {
        ...
        else if (hd_insertupdate.Value.Equals("update"))
        {
            ...
            try
            {
                ...
                WEB.Category.db_categories_update(hdicid.Value, WEB.Common.mod_menucont, vlan, ddlcate.SelectedValue, "", txtname.Text.Trim(), txtlink.Text.Trim(), type, image, Convert.ToInt32(Session["userid"]), Session["admin"].ToString(), DateTime.Now.ToString("MM/dd/yyyy hh:mm:ss tt"), DateTime.Now.ToString("MM/dd/yyyy hh:mm:ss tt"), ilevel, txtorder.Text, istatus, txtdesc.Text, hdicate.Value, "", "", "", "0", "0", "0", "0", "0");
                lttitle.Text = "Quản lý menu - Cập nhật menu thành công";
                //ghi log
                WEB.Logs.writelog("Cập nhật Nội dung: " + txtname.Text);
                UpdateList();
            }
            catch
            {
