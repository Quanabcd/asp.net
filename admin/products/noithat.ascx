<%@ Control Language="C#" AutoEventWireup="true" CodeFile="noithat.ascx.cs" Inherits="admin_products_noithat" %>
                                        ...
                                        <p>
                                            ...
                                            <table width="100%" cellspacing="1" class="admintable">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="150" class="key">
                                                            <label for="txtuser">Loại</label>
                                                            (<span style='color: red'>*</span>)
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList CssClass="inputbox " ID="ddltype" runat="server">
                                                                <asp:ListItem Text="Tổng quan" Value="0"></asp:ListItem>
                                                                <asp:ListItem Text="Nội thất" Value="2"></asp:ListItem>
                                                                <asp:ListItem Text="Ngoại thất" Value="1"></asp:ListItem>
                                                                <asp:ListItem Text="An toàn & vận hành" Value="3"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr class="hidden">
                                                        <td class="key">
                                                            <label for="listnhom">Kiểu hiển thị</label>
                                                        </td>
                                                        <td>
                                                            <asp:RadioButton GroupName="chkdisplay" Checked="true" ID="chkalbum" runat="server" Text=" Dạng album ảnh" /><br />

                                                            <asp:RadioButton ID="chklist" GroupName="chkdisplay" runat="server" Text=" Dạng danh sách tin" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="key">
