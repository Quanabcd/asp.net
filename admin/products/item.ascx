                        ...
                        <tbody>
                            <tr class="row0">
                                ...
                                <td align="center">
                                    ...
                                    <a href="/admin/?mod=prod&c=items&id=<%#Eval("iid") %>"  <%#checkrolecss("2022") %> title="Chỉnh sửa"><img src="<%=weburl%>templates/admin/images/iconedit_c.png" /></a>&nbsp; &nbsp;
                        ...
                        <div style="background:#f0f0f0">
                            <div class="row">
                                <div class="col-sm-8">
                                    <div class="block_sp">
                                        <div class="form-group">
                                            <label class="next-label">Tên sản phẩm</label> <a href="#" class="tooltip">
                                ...
                                <div class="col-sm-4">
                                    <div class="block_sp">
                                        <div class="form-group">
                                            <label class="next-label">Mã sản phẩm</label> <a href="#" class="tooltip">
                                                                <img src="../templates/admin/images/help-icon.png" />
                                    ...
                                    <div class="block_sp">
                                        ...
                                        <div class="form-group">
                                            <label class="next-label">Loại sản phẩm</label> <a href="#" class="tooltip">
                                                                    <img src="../templates/admin/images/help-icon.png" />
						...
						<div class="divFileProgressContainer1" style="display: none;"></div>
                         ...
                         <div>
                            <div class="wrapper-content  ps-relative" id="divProductVariants">
                                <label class="title-product-main  block-display mb20">Sản phẩm có nhiều phiên bản. </label><span style="color:#aaa;font-size:12px;padding-left:10px">Ví dụ: Size: S,M,L,... | Màu sắc: Xanh, Đỏ,...</span>
                                        ...
                                        <table class="table p-none tabprdm">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="col-sm-5 p-none"><b>Mẫu sản phẩm</b></th>
...
<div id="ex1" class="modal">
      <div class="modal-header ">
                    ...
                    <h4 class="modal-title">Thêm nhanh sản phẩm</h4>
                </div>
   
    <div class="modal-body">
                    <div class="">
                        <label class="next-label">Chọn danh mục cần thêm sản phẩm</label>
    ...
    <div class="modal-footer">
       ...
       <asp:LinkButton ID="lnk" runat="server" CssClass="btn btn-primary" Text="Nhân bản" OnClick="lnk_Click">Thêm sản phẩm</asp:LinkButton>
                </div>
    ...
    <div class="modal-body">
                    <div class="">
                        ...
                        <asp:DropDownList ID="ddlexport" runat="server" Width="100%"  CssClass="inputbox">
                            <asp:ListItem Text="Sản phẩm trên trang hiện tại" Value="0"></asp:ListItem>
                            <asp:ListItem Text="Sản phẩm trong danh mục" Value="1"></asp:ListItem>
                            <asp:ListItem Text="Tất cả sản phẩm" Value="2"></asp:ListItem>
                        </asp:DropDownList>
                        <br /><br />
