                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td width="150" class="key">
                                                            <label for="txtuser">Tên nhà sản xuất</label> (<span style='color:red;font-size:11px'>*</span>)
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#" class="tooltip">
                                                                ...
                                                                <span><b>Tiêu đề</b><br />
                                                                    Nhập tên nhà sản xuất (VD:Việt Nam, Mỹ, Apple,...)
                                                                </span>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="150" class="key">
                                                            <label for="txtuser">Links</label> (<span style='color:red;font-size:11px'>*</span>)
                                                        </td>
                                                        
                                                        <td>
                                                           <p>/<asp:Literal ID="txturl"  runat="server"></asp:Literal></p>
                                                        </td>
                                                    </tr>
                                                    <tr>
