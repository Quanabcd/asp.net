...
public partial class admin_weblinks_weblink: System.Web.UI.UserControl
{
    ...
    protected void UpdateList()
    {
        ...
        string[] fieldsearch = { "vcname", "vcphone", "vusername", "vcode" };
        string condition = "";
        ...
        rpitems.DataBind();
        ltpage.Text = WEB.Common.PhanTrang(weburl + "admin/?mod=prod&c=orders&key=" + key.Trim() + "&st=" + istatus.ToString() + "&order=" + iorder.ToString() + "&ordertype=" + iordertype.ToString(), curpage, numitems, 20);
    }
