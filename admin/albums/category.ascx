			...
			<asp:Panel ID="pnlist" runat="server">
			    ...
			    <ItemTemplate>
			        <tbody>
					    ...
					    <td>
						   <%#space(Eval("ilevel").ToString()) %><asp:LinkButton ID="LinkButton1" CommandName="EditDetail"  Enabled='<%#checkrole("2512") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
					    ...
					    <td align="center">
					        <asp:LinkButton ID="LinkButton2" CommandName="ChangeStatus" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")+"|"+Eval("istatus")%>'
                                        ...
                                        <td align="center">
                                            <a href="<%#weburl %>thu-vien-anh/<%#Eval("valias") %>" target="_blank" title="Xem chi tiết"><img src="<%=weburl%>templates/admin/images/view.png" /></a>&nbsp; &nbsp;
                                                         <asp:LinkButton ID="LinkButton3" CommandName="EditDetail" Visible='<%#checkrole("2512") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
                                        runat="server" ToolTip="Sửa"><img src="<%=weburl%>templates/admin/images/iconedit_c.png" /></asp:LinkButton> &nbsp &nbsp
                                            <asp:LinkButton ID="LinkButton4" CommandName="delete" Visible='<%#checkrole("2513") %>'  OnClientClick="return confirm('Bạn có muốn xóa không?')" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
                ...
                <div>
                    <p>
						...
						<tr>
							...
							<td>
							    <asp:TextBox ID="txtorder" onkeypress=" return isNumberKey(event)" CssClass="inputbox"  Width="120"   runat="server"></asp:TextBox>
							    <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                                    <span><b>Thứ tự</b><br />
                         ...
                         <table class="admintable">
						       <tbody>
                                     ...
                                     <tr>
                                        ...
                                        <span class="next-input-add-on next-input__add-on--before"><%=weburl %>thu-vien-anh/</span>
                                              ...
                                              <a href="#" class="tooltip">
                                                    ...
                                                    <span><b>Đường dẫn</b><br />
                                                       Đường dẫn tới danh mục trang album
                                                    </span>
                                                </a>   
