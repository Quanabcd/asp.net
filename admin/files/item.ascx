<%@ Control Language="C#" AutoEventWireup="true" CodeFile="item.ascx.cs" Inherits="admin_files_item" %>
    ...
    <div class="m">
        <div id="adminForm1">
                        ...
                        <table cellpadding="1" summary="" class="adminlist">
                            <thead>
                                <tr>
                                    ...
                                    <th class="title">Tiêu đề tài liệu
                                    </th>
                    ...
                    <ItemTemplate>
                        <tbody>
                            <tr class="row0">
                                ...
                                <td align="center">
                                    <asp:LinkButton ID="LinkButton3" CommandName="EditDetail"  Enabled='<%#checkrole("2622") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><%#getpic(Eval("vimg").ToString())%></asp:LinkButton></td>
                                <td>
                                    <asp:LinkButton ID="LinkButton1" CommandName="EditDetail"  Enabled='<%#checkrole("2622") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><%#Eval("vtitle")%></asp:LinkButton>
                                </td>
                                <td align="center">
                                    <input type="text" name="txtorder_<%#Eval("iid") %>" value="<%#Eval("iparam1") %>" class="txtiporder" />
                                </td>
                                ...
                                <td align="center">
                                    ...
                                    <asp:LinkButton ID="LinkButton4" CommandName="EditDetail"  Visible='<%#checkrole("2622") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><img src="<%=weburl%>templates/admin/images/iconedit_c.png" /></asp:LinkButton>
                                    &nbsp &nbsp
                                            <asp:LinkButton ID="LinkButton5" CommandName="delete" Visible='<%#checkrole("2623") %>'  OnClientClick="return confirm('Bạn có muốn xóa không?')" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                            ...
                            <tr class="row1">
                                ...
                                <td align="center">
                                    <asp:LinkButton ID="LinkButton3" CommandName="EditDetail"  Enabled='<%#checkrole("2622") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><%#getpic(Eval("vimg").ToString())%></asp:LinkButton></td>
                                <td>
                                    <asp:LinkButton ID="LinkButton6" CommandName="EditDetail" Enabled='<%#checkrole("2622") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><%#Eval("vtitle")%></asp:LinkButton>
                                </td>
                                <td align="center">
                                    <input type="text" name="txtorder_<%#Eval("iid") %>" value="<%#Eval("iparam1") %>" class="txtiporder" />
                            ...
                            <p>
                                <table cellspacing="1" class="admintable">
                                    <tbody>
                                        <tr>
                                            <td class="key">
                                                <label for="txtuser">Tiêu đề tài liệu (<span class="requirecss">*</span>)</label>
                                            </td>
                                            <td>
                                                ...
                                                <a href="#" class="tooltip">
                                                    ...
                                                    <span><b>Tiêu đề tài liệu</b><br />
                                                        Nhập tiêu đề tài liệu, độ dài tiêu đề không quá 150 ký tự
                                                    </span>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="150" class="key">
                                                <label for="txtphone">Danh mục tài liệu (<span class="requirecss">*</span>)</label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlcate" runat="server"  Width="350" CssClass="inputbox"></asp:DropDownList>
                                                <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                                    <span><b>Danh mục tài liệu</b><br />
                                                        Lựa chọn danh mục chứa tài liệu
                                                    </span>
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="key" valign="top">
                                                <label for="txtphone">File tài liệu</label>
                                            </td>
                                            <td>

                                                <asp:FileUpload ID="flfile" CssClass="upload-file" runat="server" /><br />
                                        ...
                                        <tr>
                                            <td class="key" valign="top">
                                                ...
                                                <label for="txtphone">Chi tiết (<span class="requirecss">*</span>)</label>
                                            </td>
                                            <td>
                                            ...
                                            <td class="key" valign="top">
                                                ...
                                                <a href="#" class="tooltip">
                                                    ...
                                                    <span><b>Tag liên quan</b><br />
                                                        Các từ khóa liên quan đến tài liệu cách nhau bởi dấu phảy (,)
                                                    </span>
                                                </a>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="tooltip">
                                                    ...
                                                    <span><b>Cập nhật ngày đăng</b><br />
                                                        Thay đổi ngày đăng tài liệu, ngày phải theo định dạng ngày/tháng/năm (20/10/2014)
                                                    </span>
                                                </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="chknew" runat="server" Text=" Tài liệu mới" />
                                                &nbsp  &nbsp
							    <asp:CheckBox ID="chkhot" runat="server" Text=" Tài liệu nổi bật" />
                                            </td>
                                        </tr>
                                        ...
                                        <span class="next-input-add-on next-input__add-on--before"><%=weburl %>thu-vien-tai-lieu/</span>
                                              ...
                                              <a href="#" class="tooltip">
                                                    ...
                                                    <span><b>Đường dẫn</b><br />
                                                       Đường dẫn tới thư viện tài liệu
                                                    </span>
                                                </a>   
            ...
            <asp:HiddenField ID="hdalias" runat="server" Visible="false" />
             <asp:HiddenField ID="hdfile" runat="server" Visible="false" />
