<%@ Control Language="C#" AutoEventWireup="true" CodeFile="item.ascx.cs" Inherits="admin_customer_reviews_item" %>
                            ...
                            <tr class="row0">
                               ...
                               <td align="center"><%#getdatecreateupdate(Eval("dcreatedate").ToString(),Eval("dupdate").ToString()) %>
                                ...
                                <td align="center">
                                    ...
                                    <asp:LinkButton ID="LinkButton4" CommandName="EditDetail" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><img src="<%=weburl%>templates/admin/images/iconedit_c.png" /></asp:LinkButton>
                                    &nbsp &nbsp
                                            <asp:LinkButton ID="LinkButton5" CommandName="delete" OnClientClick="return confirm('Bạn có muốn xóa không?')" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                    ...
                    <AlternatingItemTemplate>
                         <tbody>
                            <tr class="row1">
                                ...
                                <td>
                                     <asp:LinkButton ID="LinkButton6" CommandName="EditDetail" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><%#Eval("vtitle")%></asp:LinkButton>
                                </td>
                                 <td align="center"><input type="text" name="txtorder_<%#Eval("iid") %>" value="<%#Eval("iparam1") %>" class="txtiporder" />
                                </td>
                            ...
                            <p>
                                <table cellspacing="1" class="admintable">
                                    <tbody>
                                        <tr>
                                            <td class="key">
                                                <label for="txtuser">Họ tên(<span class="requirecss">*</span>)</label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtnewsname" runat="server" Width="250" CssClass="inputbox"></asp:TextBox>
                                                <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                                    <span><b>Họ tên</b><br />
                                                        Nhập họ tên người gửi câu hỏi
                                                    </span>
                                                </a>
                                            </td>
                                        </tr>
                                         <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtcompany" runat="server" Width="250" CssClass="inputbox"></asp:TextBox>
                                                <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                                    <span><b>Số điện thoại</b><br />
                                                        Nhập số điện thoại người gửi câu hỏi
                                                    </span>
                                                </a>
                                            </td>
                                        </tr>
                                         <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtemail" runat="server" Width="250" CssClass="inputbox"></asp:TextBox>
                                                <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                                    <span><b>Email</b><br />
                                                        Nhập email người gửi câu hỏi
                                                    </span>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="150" class="key">
                                                <label for="txtphone">Danh mục (<span class="requirecss">*</span>)</label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlcate" Width="250" runat="server" CssClass="inputbox"></asp:DropDownList>
                                                <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                                    <span><b>Danh mục</b><br />
                                                        Lựa chọn danh mục
                                                    </span>
                                                </a>
                                            </td>
                                         ...
                                         <tr style="display:none">
                                            <td class="key" valign="top">
                                                <label for="txtphone">Hình ảnh đại diện</label>
                                            </td>
                                            <td>
                                            
                                                <asp:FileUpload ID="flupload" CssClass="upload-file" runat="server" /><br />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txttieude" runat="server" Width="450" CssClass="inputbox"></asp:TextBox>
                                                <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                                    <span><b>Tiêu đề</b><br />
                                                        Nhập tiêu đề hỏi đáp
                                                    </span>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="key" valign="top">
                                                <label for="txtphone">Câu hỏi (<span class="requirecss">*</span>)</label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtdesc" TextMode="MultiLine" Height="80" runat="server" Width="250" CssClass="inputbox-mota"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td class="key" valign="top">
                                                ...
                                                <label for="txtphone">Nội dung trả lời (<span class="requirecss">*</span>)</label>
                                            </td>
                                            <td>
                                        ...
                                        <tr style="display:none">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txt_tag" runat="server" Width="400" CssClass="inputbox"></asp:TextBox>
                                                <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                                    <span><b>Tag liên quan</b><br />
                                                        Các từ khóa liên quan đến tin cách nhau bởi ;
                                                    </span>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                lúc &nbsp;<asp:DropDownList ID="ddlhour" runat="server" CssClass="inputbox"></asp:DropDownList> giờ&nbsp;&nbsp;
                                                <asp:DropDownList ID="ddlminute" runat="server" CssClass="inputbox"></asp:DropDownList> phút
                                                <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                        ...
                                        <tr>
                                            <td class="key">
                                                <label for="listnhom">Thứ tự</label>(<span class="requirecss">*</span>)
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="chknew" runat="server" Text=" Hỏi đáp mới" />
                                                &nbsp  &nbsp
							    <asp:CheckBox ID="chkhot" runat="server" Text="  Hỏi đáp nổi bật" />
                                            </td>
                                        </tr>
                            ...
                            <p>
                                <table class="admintable">
                                    <tbody>
                                        ...
                                        <span class="next-input-add-on next-input__add-on--before"><%=weburl %>hoi-dap/</span>
