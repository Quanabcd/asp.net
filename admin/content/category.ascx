<%@ Control Language="C#" AutoEventWireup="true" CodeFile="category.ascx.cs" Inherits="admin_content_category" %>
			...
			<asp:Panel ID="pnlist" runat="server">
			    ...
			    <ItemTemplate>
			        <tbody>
					    ...
					    <td>
						   <%#space(Eval("ilevel").ToString()) %><asp:LinkButton  Enabled='<%#checkrole("2212") %>' ID="LinkButton1" CommandName="EditDetail" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
					    ...
					    <td align="center">
					        <asp:LinkButton ID="LinkButton2" CommandName="ChangeStatus" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")+"|"+Eval("istatus")%>'
                                        ...
                                        <td align="center">
                                            ...
                                            <asp:LinkButton ID="LinkButton3" CommandName="EditDetail" Visible='<%#checkrole("2212") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
                                        runat="server" ToolTip="Sửa"><img src="<%=weburl%>templates/admin/images/iconedit_c.png" /></asp:LinkButton> &nbsp &nbsp
                                            <asp:LinkButton ID="LinkButton4" CommandName="delete" Visible='<%#checkrole("2213") %>'  OnClientClick="return confirm('Bạn có muốn xóa không?')" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
                    ...
                    <AlternatingItemTemplate>
					    ...
					    <td>
						   <%#space(Eval("ilevel").ToString()) %><asp:LinkButton ID="LinkButton1" CommandName="EditDetail" Enabled='<%#checkrole("2212") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
                                        runat="server" ToolTip="Sửa"><%#Eval("vname")%></asp:LinkButton>
					    </td>
                ...
                <div>
                    <p>
							...
							<td>
                                ...
                                <a href="#" class="tooltip">
                                                    ...
                                                    <span><b>Tiêu đề danh mục</b><br />
                                                        Nhập tiêu đề của danh mục, độ dài tiêu đề không quá 150 ký tự
                                                    </span>
                                                </a>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
							    <asp:TextBox ID="txtorder" Width="120" onkeypress=" return isNumberKey(event)" CssClass="inputbox"  runat="server"></asp:TextBox>
							    <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                                    <span><b>Thứ tự</b><br />
                                        ...
                                        <span class="next-input-add-on next-input__add-on--before"><%=weburl %></span>
                                              ...
                                              <a href="#" class="tooltip">
                                                    ...
                                                    <span><b>Đường dẫn</b><br />
                                                       Đường dẫn tới danh mục trang nội dung
                                                    </span>
                                                </a>   
