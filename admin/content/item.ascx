<%@ Control Language="C#" AutoEventWireup="true" CodeFile="item.ascx.cs" Inherits="admin_content_item" %>
                    ...
                    <ItemTemplate>
                        <tbody>
                            <tr class="row0">
                                ...
                                <td align="center">
                                    <asp:LinkButton ID="LinkButton3" CommandName="EditDetail" Enabled='<%#checkrole("2222") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><%#getpic(Eval("vimg").ToString())%></asp:LinkButton></td>
                                <td>
                                    <asp:LinkButton ID="LinkButton1" CommandName="EditDetail" Enabled='<%#checkrole("2222") %>'  CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                               ...
                               <td align="center"><%#getdatecreateupdate(Eval("dcreatedate").ToString(),Eval("dupdate").ToString()) %>
                                ...
                                <td align="center">
                                     ...
                                     <asp:LinkButton ID="LinkButton4" CommandName="EditDetail" Visible='<%#checkrole("2222") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><img src="<%=weburl%>templates/admin/images/iconedit_c.png" /></asp:LinkButton>
                                    &nbsp &nbsp
                                            <asp:LinkButton ID="LinkButton5" CommandName="delete" Visible='<%#checkrole("2223") %>' OnClientClick="return confirm('Bạn có muốn xóa không?')" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                            ...
                            <tr class="row1">
                                ...
                                <td align="center">
                                    <asp:LinkButton ID="LinkButton3" CommandName="EditDetail" Enabled='<%#checkrole("2222") %>'  CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><%#getpic(Eval("vimg").ToString())%></asp:LinkButton></td>
                                <td>
                                     <asp:LinkButton ID="LinkButton6" CommandName="EditDetail" Enabled='<%#checkrole("2222") %>'  CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><%#Eval("vtitle")%></asp:LinkButton>
                                </td>
                                 <td align="center"><input type="text" name="txtorder_<%#Eval("iid") %>" value="<%#Eval("iparam1") %>" class="txtiporder" />
                                </td>
                                ...
                                <div class="col-sm-8">
                                    <div class="block_sp">
                                        <div class="form-group">
                                            <label class="next-label">Tiêu đề</label> <a href="#" class="tooltip">
                                             ...
                                             <asp:TextBox ID="txtnewsname" runat="server" Width="100%" CssClass="inputbox" placeholder="Nhập tiêu đề trang"></asp:TextBox>
                                        </div>
                                         <div class="form-group">
                                         ...
                                         <div class="form-group">
                                             <label class="next-label" data-bind="text:Title">Danh sách tag liên quan</label><a href="#" class="tooltip">
                                                    ...
                                                    <span><b>Tag liên quan</b><br />
                                                        Các từ khóa liên quan đến nội dung cách nhau bởi dấu phảy (,)
                                                    </span>
                                                </a>
                                   ...
                                   <div class="col-sm-4">
                                        <div class="block_sp">
                                         ...
                                         <div class="block_sp">
                                        <p class="ttg">Danh mục trang nội dung <a href="#" class="tooltip">
                                                                    <img src="../templates/admin/images/help-icon.png" />
                                                                    <span><b>Danh mục trang nội dung</b><br />
                                                                        Lưa chọn danh mục trang nội dung
                                                                    </span>
                                                                </a></p>
                                        <div class="form-group">
                                        ...
                                        <p class="ttg">Ngày đăng <a href="#" class="tooltip">
                                                    ...
                                                    <span><b>Cập nhật ngày đăng</b><br />
                                                        Thay đổi ngày đăng nội dung, ngày phải theo định dạng ngày/tháng/năm (20/10/2014)
                                                    </span>
                                                </a></p>
                                        <div class="form-group">
                                        ...
                                        <p class="ttg">Thứ tự <a href="#" class="tooltip">
                                                                        <img src="../templates/admin/images/help-icon.png" />
                                                                        <span><b>Thứ tự</b><br />
                                                                            Thứ tự hiện thị của trang nội dung trong 1 danh mục
                                                                        </span>
                                                                    </a></p>
                                                 <div class="form-group">
