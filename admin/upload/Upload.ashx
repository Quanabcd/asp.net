...
public class upload : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        for (int n = 0; n < request.Files.Count; n++)
        {
            ...
            if (System.IO.File.Exists(System.Web.HttpContext.Current.Server.MapPath("~/") + "/uploads/products/relative/" + image) == true)
            ...
            if (ext == ".png")
                objImage.Save(System.Web.HttpContext.Current.Server.MapPath("~/") + "/uploads/products/relative/thumbs/" + image, System.Drawing.Imaging.ImageFormat.Png);
            if (ext == ".jpg" || ext == ".jpeg")
                objImage.Save(System.Web.HttpContext.Current.Server.MapPath("~/") + "/uploads/products/relative/thumbs/" + image, System.Drawing.Imaging.ImageFormat.Jpeg);
            if (ext == ".gif")
                objImage.Save(System.Web.HttpContext.Current.Server.MapPath("~/") + "/uploads/products/relative/thumbs/" + image, System.Drawing.Imaging.ImageFormat.Gif);
            ...
            if (ext == ".png")
                oImage.Save(System.Web.HttpContext.Current.Server.MapPath("~/") + "/uploads/products/relative/" + image, System.Drawing.Imaging.ImageFormat.Png);
            if (ext == ".jpg" || ext == ".jpeg")
                oImage.Save(System.Web.HttpContext.Current.Server.MapPath("~/") + "/uploads/products/relative/" + image, System.Drawing.Imaging.ImageFormat.Jpeg);
            if (ext == ".gif")
                oImage.Save(System.Web.HttpContext.Current.Server.MapPath("~/") + "/uploads/products/relative/" + image, System.Drawing.Imaging.ImageFormat.Gif);
            ...
            string jsonresult = serializer.Serialize(new { success = "true", fn = image, id = -1 });
