                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#" class="tooltip">
                                                                ...
                                                                <span><b>Tiêu đề</b><br />
                                                                    Nhập tên nhóm hotel (VD:Điện thoại, máy tính)
                                                                </span>
                                                            </a>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div>
                                       ...
                                       <div class="next-input--stylized naq">
                                        <span class="next-input-add-on next-input__add-on--before"><i class="fa fa-search"></i> </span>
                                                   ...
                                                   <asp:TextBox ID="txtsearch" Width="400" runat="server" CssClass="txtpa" placeholder="Tìm kiếm hotel"></asp:TextBox>
                                    </div>
