<%@ Control Language="C#" AutoEventWireup="true" CodeFile="price.ascx.cs" Inherits="admin_products_price" %>
                    ...
                    <div id="adminForm1">
                        ...
                        <asp:Panel ID="pndetail" runat="server" Visible="false">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td width="150" class="key">
                                                            <label for="txtuser">Tiêu đề</label> (<span style='color:red;font-size:11px'>*</span>)
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtname" runat="server" placeholder="Từ 2.000.0000 đến 5.000.000" name="txtname" Width="250" CssClass="inputbox error" minlength="2" required="" aria-required="true" aria-invalid="true"></asp:TextBox>
                                                            <a href="#" class="tooltip">
                                                                <img src="../templates/admin/images/help-icon.png" />
                                                                <span><b>Tiêu đề</b><br />
                                                                    Nhập tiêu đề khoảng giá (VD:2.000.000 - 5.000.000)
                                                                </span>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="150" class="key">
                                                            <label for="txtuser">Khoảng giá</label> (<span style='color:red;font-size:11px'>*</span>)
                                                        </td>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td style="padding:0px">
                                                                        Từ<br /> <asp:TextBox ID="txtfrom" runat="server" name="txtname" Width="100" CssClass="inputbox error" minlength="2" required="" aria-required="true" aria-invalid="true"></asp:TextBox>
                                                                    </td>
                                                                    <td></td>
                                                                    <td>
                                                                       Đến<br /> <asp:TextBox ID="txtto" runat="server" name="txtto" Width="100" CssClass="inputbox error" minlength="2" required="" aria-required="true" aria-invalid="true"></asp:TextBox>
                                                                        <a href="#" class="tooltip">
                                                                        <img src="../templates/admin/images/help-icon.png" />
                                                                        <span><b>Khoảng giá</b><br />
                                                                           Khoảng giá phải là số (VD:2000000, 5000000)
                                                                        </span>
                                                                    </a>
                                                                    </td>
                                                                </tr>
                                                     ...
                                                     <tr>
                                                        <td class="key">
                                                            <label for="listnhom">Thứ tự</label> (<span style='color:red;font-size:11px'>*</span>)
                                                        </td>
                                                        <td>
                                                            ...
                                                            <a href="#" class="tooltip">
                                                                <img src="../templates/admin/images/help-icon.png" />
                                                                <span><b>Thứ tự</b><br />
                                                                    Nhập thứ tự hiển thị của nhà sản xuất(VD:1,2,3...)
                                                                </span>
                                                            </a>
                                                        </td>
                                                    </tr>
                            ...
                            <div class="ad-cates-list-ck">
                                <p style="font-weight:bold;line-height:30px;">Chọn danh sách danh mục sản phẩm có khoảng giá này</p>
