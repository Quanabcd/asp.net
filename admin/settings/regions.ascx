<%@ Control Language="C#" AutoEventWireup="true" CodeFile="regions.ascx.cs" Inherits="admin_settings_regions" %>
<div class="widget">
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtname" runat="server" name="txtname" Width="364" CssClass="inputbox error" minlength="2" required="" aria-required="true" aria-invalid="true"></asp:TextBox>
                                                             <a href="#" class="tooltip">
                                                               ...
                                                               <span><b>Tiêu đề</b><br />
                                                                    Nhập tên tỉnh thành, có thể thêm nhiều tỉnh thành 1 lúc, các tỉnh thành cách nhau bởi dấu phảy. VD: Nam Định, Thái Bình, Ninh Bình
                                                                </span>
                                                            </a>
                                                        </td>
                                                    </tr>
