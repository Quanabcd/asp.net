<%@ Control Language="C#" AutoEventWireup="true" CodeFile="language.ascx.cs" Inherits="admin_settings_language" %>
<div class="widget">
                                    ...
                                    <table cellpadding="1" summary="" class="adminlist">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="title">Tên ngôn ngữ
                                                </th>
                                                 <th style="text-align: center;" width="12%" class="title">Mã ngôn ngữ
                                                </th>
                                                <th style="text-align: center;" width="8%" class="title">Thứ tự
                                                </th>
                                                <th width="8%" class="title">Trạng thái
                                                </th>
                                                <th width="12%" class="title"></th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tr class="row0">
                                           ...
                                           <td align="center"><%#getstt()%></td>
                                            ...
                                            <td align="center">
                                                ...
                                                &nbsp &nbsp
                                                <a href="?mod=settings&c=language&langid=<%#Eval("vimg")%>" title="Xem danh sách"><img src="<%=weburl%>templates/admin/images/iconds.png" /></a>  &nbsp &nbsp
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td width="150" class="key">
                                                            <label for="txtuser">Tên ngôn ngữ</label>
                                                        </td>
                                                        <td>
                                                            ...
                                                            <a href="#" class="tooltip">
                                                                ...
                                                                <span><b>Tên ngôn ngữ</b><br />
                                                                    Nhập tên ngôn ngữ vd: Tiếng Anh, Tiếng Việt, ...
                                                                </span>
                                                            </a>
                                                        </td>
                                                    </tr>
