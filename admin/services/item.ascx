                        ...
                        <div>
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="block_sp">
                                        <p class="ttg">
                                            Danh mục <a href="#" class="tooltip">
                                                <img src="../templates/admin/images/help-icon.png" />
                                                <span><b>Danh mục dịch vụ</b><br />
                                                    Lưa chọn danh mục  dịch vụ
                                                </span>
                                            </a>
                                        </p>
                                        <div class="form-group">
                                    ...
                                    <div class="block_sp">
                                        <p class="ttg">
                                            Ngày đăng <a href="#" class="tooltip">
                                                <img src="../templates/admin/images/help-icon.png" />
                                    ...
                                    <div class="block_sp">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                Dịch vụ mới
                                                &nbsp  &nbsp
							    <asp:CheckBox ID="chkhot" runat="server" Text=" " />
                                                Dịch vụ nổi bật
                                            </div>
                                        </div>
                                    </div>
