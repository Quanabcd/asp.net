<%@ Control Language="C#" AutoEventWireup="true" CodeFile="category.ascx.cs" Inherits="admin_services_category" %>
			...
			<asp:Panel ID="pnlist" runat="server">
			    ...
			    <ItemTemplate>
			        <tbody>
					    ...
					    <td>
						   <%#space(Eval("ilevel").ToString()) %><asp:LinkButton ID="LinkButton1" CommandName="EditDetail"  Enabled='<%#checkrole("2312") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
					    ...
					    <td align="center">
					        <asp:LinkButton ID="LinkButton2" CommandName="ChangeStatus" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")+"|"+Eval("istatus")%>'
                                        ...
                                        <td align="center">
                                            ...
                                            <asp:LinkButton ID="LinkButton3" CommandName="EditDetail" Visible='<%#checkrole("2312") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
                                        runat="server" ToolTip="Sửa"><img src="<%=weburl%>templates/admin/images/iconedit_c.png" /></asp:LinkButton> &nbsp &nbsp
                                            <asp:LinkButton ID="LinkButton4" CommandName="delete" Visible='<%#checkrole("2313") %>'  OnClientClick="return confirm('Bạn có muốn xóa không?')" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
                                        ...
                                        <span class="next-input-add-on next-input__add-on--before"><%=weburl %></span>
                                              ...
                                              <a href="#" class="tooltip">
                                                    ...
                                                    <span><b>Đường dẫn</b><br />
                                                       Đường dẫn tới danh mục trang dịch vụ
                                                    </span>
                                                </a>   
