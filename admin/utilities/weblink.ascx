<%@ Control Language="C#" AutoEventWireup="true" CodeFile="weblink.ascx.cs" Inherits="admin_weblinks_weblink" %>
                                        ...
                                        <div class="resp-tabs-container hor_1">
                                            <div>
                                                <p>
                                                    ...
                                                    <span><b>Tên liên kết</b><br />
                                                        Tên liên kết. VD: liên kết lấy từ vnexpress.net, ...
                                                    </span>
                                                </a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtlink" runat="server" Width="364" CssClass="inputbox"></asp:TextBox>
                                                                    <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                                    <span><b>Link liên kết</b><br />
                                                        Link liên kết lấy từ các trang web. VD: http://vnexpress.net
                                                    </span>
                                                </a>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox CssClass="input-order" ID="txtorder"  runat="server">1</asp:TextBox>
                                                                    <a href="#" class="tooltip">
                                                    <img src="../templates/admin/images/help-icon.png" />
                                                    <span><b>Thứ tự</b><br />
                                                        Thứ tự hiển thị của liên kết trên website so với các liên kết khác
                                                    </span>
                                                </a>
