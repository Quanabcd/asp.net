...
public partial class admin_advs_adv1 : System.Web.UI.UserControl
{
    ...
    protected void lnkupdate_Click(object sender, EventArgs e)
    {
        ...
        if (this.flupload.FileName.Trim().Length > 0)
        {
            ...
            if (fileextention.Equals(".jpg") || fileextention.Equals(".gif") || fileextention.Equals(".bmp") || fileextention.Equals(".png") || fileextention.Equals(".swf"))
                {
                ...
                {
                    ltdetailmsg.Visible = true;
                    ltdetailmsg.Text = "<p class='merror' style='color: #f00;margin: 0;padding: 12px 15px 0px 15px;font-size: 12px;'>Không hỗ trợ ảnh dạng *" + fileextention + ". Chỉ hỗ trợ định dạng *.jpg,*.gif,*.bmp,*.png,*.swf</p>";
                    return;
                }
    ...
    public string getpic_flash(string str)
    {
        if(str.Length>0)
        {
            ...
            {
                return "<img height='50' style='max-width:300px' src='" + weburl + "uploads/qc/" + str +  "'>";
            }
