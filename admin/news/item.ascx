                    ...
                    <ItemTemplate>
                        <tbody>
                            <tr class="row0">
                                ...
                                <td align="center">
                                    <asp:LinkButton ID="LinkButton3"  Enabled='<%#checkrole("2122") %>' CommandName="EditDetail" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><%#getpic(Eval("vimg").ToString())%></asp:LinkButton></td>
                                <td>
                                    <asp:LinkButton ID="LinkButton1"  Enabled='<%#checkrole("2122") %>' CommandName="EditDetail" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                ...
                                <td align="center">
                                    ...
                                    <asp:LinkButton ID="LinkButton4" CommandName="EditDetail" Visible='<%#checkrole("2122") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><img src="<%=weburl%>templates/admin/images/iconedit_c.png" /></asp:LinkButton>
                                    &nbsp &nbsp
                                            <asp:LinkButton ID="LinkButton5" CommandName="delete" Visible='<%#checkrole("2123") %>' OnClientClick="return confirm('Bạn có muốn xóa không?')" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                    ...
                    <AlternatingItemTemplate>
                        <tbody>
                            <tr class="row1">
                                ...
                                <td align="center">
                                    <asp:LinkButton ID="LinkButton3" CommandName="EditDetail" Enabled='<%#checkrole("2122") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><%#getpic(Eval("vimg").ToString())%></asp:LinkButton></td>
                                <td>
                                    <asp:LinkButton ID="LinkButton6" CommandName="EditDetail" Enabled='<%#checkrole("2122") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"iid")%>'
                                        runat="server" ToolTip="Sửa"><%#Eval("vtitle")%></asp:LinkButton>
                                </td>
                                <td align="center">
                                    <input type="text" name="txtorder_<%#Eval("iid") %>" value="<%#Eval("iparam1") %>" class="txtiporder" />
