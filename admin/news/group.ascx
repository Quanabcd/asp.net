                                ...
                                <ItemTemplate>
                                    <tbody>
                                      	    <tr class="row0">
					                            ...
					                            <td>
						                           <%#space(Eval("ilevel").ToString()) %><asp:LinkButton ID="LinkButton1" CommandName="EditDetail" Enabled='<%#checkrole("2142") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
					                            ...
					                            <td align="center">
					                                <asp:LinkButton ID="LinkButton2" CommandName="ChangeStatus" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")+"|"+Eval("istatus")%>'
                                                                ...
                                                                <td align="center">
                                                                    ...
                                                                    <asp:LinkButton ID="LinkButton3" CommandName="EditDetail" Visible='<%#checkrole("2142") %>' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
                                                                runat="server" ToolTip="Sửa"><img src="<%=weburl%>templates/admin/images/iconedit_c.png" /></asp:LinkButton> &nbsp &nbsp
                                                                    <asp:LinkButton ID="LinkButton4" CommandName="delete" Visible='<%#checkrole("2143") %>'  OnClientClick="return confirm('Bạn có muốn xóa không?')" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
                                ...
                                <AlternatingItemTemplate>
                                     <tbody>
                                      	    <tr class="row1">
					                            ...
					                            <td>
						                           <%#space(Eval("ilevel").ToString()) %><asp:LinkButton ID="LinkButton1" Enabled='<%#checkrole("2142") %>' CommandName="EditDetail" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"icid")%>'
                                                                runat="server" ToolTip="Sửa"><%#Eval("vname")%></asp:LinkButton>
					                            </td>
                        ...
                        <asp:Panel ID="pndetail" runat="server" Visible="false">
                            <div id="parentHorizontalTab" class="divvalidate">
                                <ul class="resp-tabs-list hor_1">
                                    ...
                                    <li>Tùy chỉnh</li>
                                    <li>Thiết lập SEO</li>
                                 <asp:Literal ID="ltnewstt" runat="server"></asp:Literal>
                                </ul>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#" class="tooltip">
                                                                ...
                                                                <span><b>Tiêu đề</b><br />
                                                                    Nhập tên nhóm tin (VD:Điện thoại, máy tính)
                                                                </span>
                                                            </a>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div>
                                       ...
                                       <div class="next-input--stylized naq">
                                        <span class="next-input-add-on next-input__add-on--before"><i class="fa fa-search"></i> </span>
                                                   ...
                                                   <asp:TextBox ID="txtsearchnews" Width="400" runat="server" CssClass="txtpa" placeholder="Tìm kiếm tin"></asp:TextBox>
                                    </div>
                                        ...
                                        <asp:Repeater ID="rpitemssp" runat="server">
                                            <ItemTemplate>
                                                <div class="col-sm-6 itesp"  id="blc_<%#Eval("ino") %>">
                                                    ...
                                                    <div class="col-sm-1 no-padding"><a data="<%#Eval("ino") %>" href="javascipt:void(0);" title="Xóa" class="deleteitsp"><i class="fa fa-close"></i></a> <img class="img-responsive" src="../uploads/news/thumbs/<%#Eval("vimg") %>" alt="<%#Eval("vtitle") %>" /></div>
